...
它不是海投工具，也不是简历美化器，而是帮助候选人系统化完成：**职业定位 → 岗位筛选 → 简历定制 → 求职沟通 → 面试准备 → 管道管理 → 复盘成长**。

> 公司用 AI 筛候选人。我们把 AI 交给候选人，让候选人更清醒地筛机会、讲清自己、管理职业选择。

## 为什么需要中文版

海外求职工具通常围绕 LinkedIn、Greenhouse、Lever、Ashby、ATS、Cover Letter 和 Recruiter Outreach 设计。

中文求职市场不一样：

- Boss 直聘、猎聘、脉脉、拉勾、智联、前程无忧、公司官网、内推、微信群、猎头私聊并存；
- 中高阶岗位更重视项目经历、业务结果、职级对标、组织复杂度、管理经验和转型叙事；
- 很多机会来自聊天、内推、人脉和半结构化 JD，而不是标准 ATS；
- 候选人不仅需要简历，还需要 Boss 开场白、猎头回复、内推说明、面试项目讲稿、谈薪话术和 offer 判断。

所以 **AI 求职助手** 是中文原生设计，不是简单汉化。
